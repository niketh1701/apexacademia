...
import 'package:apexacademia/teacher/studentslist.dart';
...
class trhome extends StatefulWidget {
  const trhome({super.key});

  @override
  State<trhome> createState() => _homeState();
}

class _homeState extends State<trhome> {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      }, child: Text('Students',style: TextStyle(color: Colors.black)))
      ],
      ),
      body:
      Expanded(
